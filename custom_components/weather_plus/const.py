...
CONF_USE_TEMPERATURE = "use_temperature"
...
DEFAULT_END_HOUR = 9
DEFAULT_USE_TEMPERATURE = True
DEFAULT_MIN_TEMPERATURE = 60
DEFAULT_MAX_TEMPERATURE = 75
DEFAULT_USE_ELEVATION = True
DEFAULT_MAX_ELEVATION = 15
